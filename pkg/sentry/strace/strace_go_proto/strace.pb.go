...
/*
Package strace_go_proto is a generated protocol buffer package.
...
func (*Strace) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

type isStrace_Info interface{ isStrace_Info() }
...
func (*StraceEnter) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*StraceExit) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func init() { proto.RegisterFile("pkg/sentry/strace/strace.proto", fileDescriptor0) }
