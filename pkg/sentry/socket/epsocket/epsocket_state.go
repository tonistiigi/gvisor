...
func (x *ioSequencePayload) beforeSave() {}
func (x *ioSequencePayload) save(m state.Map) {
	x.beforeSave()
	m.Save("ctx", &x.ctx)
	m.Save("src", &x.src)
}

func (x *ioSequencePayload) afterLoad() {}
func (x *ioSequencePayload) load(m state.Map) {
	m.Load("ctx", &x.ctx)
	m.Load("src", &x.src)
}
...
func init() {
	...
	state.Register("epsocket.ioSequencePayload", (*ioSequencePayload)(nil), state.Fns{Save: (*ioSequencePayload).save, Load: (*ioSequencePayload).load})
