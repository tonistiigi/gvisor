...
func (x *AddrRangeSeq) beforeSave() {}
func (x *AddrRangeSeq) save(m state.Map) {
	x.beforeSave()
	m.Save("data", &x.data)
...
func (x *AddrRangeSeq) afterLoad() {}
func (x *AddrRangeSeq) load(m state.Map) {
	m.Load("data", &x.data)
...
func init() {
	...
	state.Register("usermem.AddrRangeSeq", (*AddrRangeSeq)(nil), state.Fns{Save: (*AddrRangeSeq).save, Load: (*AddrRangeSeq).load})
}
