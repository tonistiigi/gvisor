...
func (x *fileRefcountIterator) beforeSave() {}
func (x *fileRefcountIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *fileRefcountIterator) afterLoad() {}
func (x *fileRefcountIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}

func (x *fileRefcountGapIterator) beforeSave() {}
func (x *fileRefcountGapIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *fileRefcountGapIterator) afterLoad() {}
func (x *fileRefcountGapIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}
...
func (x *invalidateArgs) beforeSave() {}
func (x *invalidateArgs) save(m state.Map) {
	x.beforeSave()
	m.Save("ar", &x.ar)
	m.Save("opts", &x.opts)
}

func (x *invalidateArgs) afterLoad() {}
func (x *invalidateArgs) load(m state.Map) {
	m.Load("ar", &x.ar)
	m.Load("opts", &x.opts)
}

func (x *fileRefcountSetFunctions) beforeSave() {}
func (x *fileRefcountSetFunctions) save(m state.Map) {
	x.beforeSave()
}

func (x *fileRefcountSetFunctions) afterLoad() {}
func (x *fileRefcountSetFunctions) load(m state.Map) {
}
...
func (x *pmaIterator) beforeSave() {}
func (x *pmaIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *pmaIterator) afterLoad() {}
func (x *pmaIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}

func (x *pmaGapIterator) beforeSave() {}
func (x *pmaGapIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *pmaGapIterator) afterLoad() {}
func (x *pmaGapIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}
...
func (x *vmaIterator) beforeSave() {}
func (x *vmaIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *vmaIterator) afterLoad() {}
func (x *vmaIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}

func (x *vmaGapIterator) beforeSave() {}
func (x *vmaGapIterator) save(m state.Map) {
	x.beforeSave()
	m.Save("node", &x.node)
	m.Save("index", &x.index)
}

func (x *vmaGapIterator) afterLoad() {}
func (x *vmaGapIterator) load(m state.Map) {
	m.Load("node", &x.node)
	m.Load("index", &x.index)
}
...
func init() {
	...
	state.Register("mm.fileRefcountIterator", (*fileRefcountIterator)(nil), state.Fns{Save: (*fileRefcountIterator).save, Load: (*fileRefcountIterator).load})
	state.Register("mm.fileRefcountGapIterator", (*fileRefcountGapIterator)(nil), state.Fns{Save: (*fileRefcountGapIterator).save, Load: (*fileRefcountGapIterator).load})
	...
	state.Register("mm.invalidateArgs", (*invalidateArgs)(nil), state.Fns{Save: (*invalidateArgs).save, Load: (*invalidateArgs).load})
	state.Register("mm.fileRefcountSetFunctions", (*fileRefcountSetFunctions)(nil), state.Fns{Save: (*fileRefcountSetFunctions).save, Load: (*fileRefcountSetFunctions).load})
	...
	state.Register("mm.pmaIterator", (*pmaIterator)(nil), state.Fns{Save: (*pmaIterator).save, Load: (*pmaIterator).load})
	state.Register("mm.pmaGapIterator", (*pmaGapIterator)(nil), state.Fns{Save: (*pmaGapIterator).save, Load: (*pmaGapIterator).load})
	...
	state.Register("mm.vmaIterator", (*vmaIterator)(nil), state.Fns{Save: (*vmaIterator).save, Load: (*vmaIterator).load})
	state.Register("mm.vmaGapIterator", (*vmaGapIterator)(nil), state.Fns{Save: (*vmaGapIterator).save, Load: (*vmaGapIterator).load})
