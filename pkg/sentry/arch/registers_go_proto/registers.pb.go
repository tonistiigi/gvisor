...
/*
Package registers_go_proto is a generated protocol buffer package.
...
func (*AMD64Registers) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*Registers) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

type isRegisters_Arch interface{ isRegisters_Arch() }
...
func init() { proto.RegisterFile("pkg/sentry/arch/registers.proto", fileDescriptor0) }
