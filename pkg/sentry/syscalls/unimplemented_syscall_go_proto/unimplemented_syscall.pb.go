...
func (*UnimplementedSyscall) Descriptor() ([]byte, []int) {
	return fileDescriptor_unimplemented_syscall_1b7df47d4eccfeaa, []int{0}
}
...
func init() {
	proto.RegisterFile("pkg/sentry/syscalls/unimplemented_syscall.proto", fileDescriptor_unimplemented_syscall_1b7df47d4eccfeaa)
}

var fileDescriptor_unimplemented_syscall_1b7df47d4eccfeaa = []byte{
